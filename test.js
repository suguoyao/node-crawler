...
// 定义网络爬虫的目标地址：自如友家的主页
var url = 'http://let.zbase.cn/mynew2/data/zs_list.ashx?method=dg_list&R=428&gsmc=&zg=&hylb=&gjz=&pageindex=1&pagesize=10';
...
http.get(url, function (res) {
  ...
  res.on('end', function () {
    ...
    console.log(html)
    fs.appendFile('/Users/sugars/nodejs/crawler/result.txt', html, function (err) {
